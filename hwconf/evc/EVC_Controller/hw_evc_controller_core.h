...
#ifndef HW_EVC_CONTROLLER_CORE_H_
#define HW_EVC_CONTROLLER_CORE_H_

#ifdef HW_EVC_CONTROLLER_IS_MK3
#define HW_NAME					"EVC_CONTROLLER_MK3"
#elif defined(HW_EVC_CONTROLLER_IS_MK4)
#define HW_NAME					"EVC_CONTROLLER_MK4"
#elif defined(HW_EVC_CONTROLLER_IS_MK5)
#define HW_NAME					"EVC_CONTROLLER_MK5"
#elif defined(HW_EVC_CONTROLLER_IS_MK6)
#ifdef HW_EVC_CONTROLLER_IS_HP
#define HW_NAME					"EVC_CONTROLLER_MK6_HP"
#elif defined(HW_EVC_CONTROLLER_IS_MAX)
#define HW_NAME					"EVC_CONTROLLER_MK6_MAX"
#else
#define HW_NAME					"EVC_CONTROLLER_MK6"
#endif
#elif defined(HW_EVC_CONTROLLER_IS_MK1)
#define HW_NAME					"EVC_CONTROLLER_MK1"
#else
...
#if defined(HW_EVC_CONTROLLER_IS_MK6)
#ifdef HW_EVC_CONTROLLER_IS_MAX
...
#if defined(HW_EVC_CONTROLLER_IS_MK3) || defined(HW_EVC_CONTROLLER_IS_MK4) || defined(HW_EVC_CONTROLLER_IS_MK5) || defined(HW_EVC_CONTROLLER_IS_MK6)
// Shutdown pin
...
// Precharge 
#ifndef PRECHARGE_TARGET
#define PRECHARGE_TARGET			40		// Target voltage during precharge as a fraction of input voltage
#endif

// Input voltage
#define GET_INPUT_VOLTAGE()		((((V_REG / 4095.0) * (float)ADC_Value[ADC_IND_VIN_SENS]) - 0.1) * ((VIN_R1+VIN_R2) / VIN_R2))
...
// ESTOP Peripheral
#define HW_ESTOP_GPIO			GPIOA 
#define HW_ESTOP_PIN			8

//Precharge Peripheral
#define HW_PRECHARGE_GPIO		GPIOB
#define HW_PRECHARGE_PIN		5
